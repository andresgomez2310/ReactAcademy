...
Requisitos A Tener En Cuenta:
 ...
 Un archivo .jsx por componente con su propio CSS: Separación modular ubicada en src/components/.
 Gitignore configurado: La carpeta node_modules no se incluye en el repositorio.
